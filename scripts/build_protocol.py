...
if __name__ == "__main__":
    ...
    parser.add_argument("--sources-path", type=Path, default=root_path / "scripts/sources")
    parser.add_argument("--labot-path", type=Path, default=root_path /"scripts")
    ...
    with (args.labot_path / "protocol.pk").open("rb") as f:
        types = pickle.load(f)
